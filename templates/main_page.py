...
def motion_detection():
	global current_frame, previous_frame, recording, timer_started, rec_stopped_time, send_notification
...
def index():
	global current_video, initi, send_notification
...
def hello():
    ...
    return jsonify(send_notification) # Send recording Status to client
